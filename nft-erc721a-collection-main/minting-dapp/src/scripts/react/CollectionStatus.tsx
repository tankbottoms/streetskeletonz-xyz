      ...
      <>
        <div className="collection-status">
          <div className="user-address">
            <span className="address"><img src={'/build/images/walletIcon.webp'} style={{width:'30px', display: 'inline-block', marginRight:'10px', verticalAlign: '-8px', filter:'brightness(5)'}}/> {this.props.userAddress}</span>
          </div>
