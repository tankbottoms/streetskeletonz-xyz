...
interface PangoPupsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "checkNameUsed(bytes32)": FunctionFragment;
    ...
    "setNameAdmin(uint256,bytes32)": FunctionFragment;
...
export class PangoPups extends BaseContract {
  ...
  checkNameUsed(name: BytesLike, overrides?: CallOverrides): Promise<boolean>;
